...
![Version: 0.1.12](https://img.shields.io/badge/Version-0.1.12-informational?style=flat-square) ![AppVersion: 1.0](https://img.shields.io/badge/AppVersion-1.0-informational?style=flat-square)
...
| nodeSelector | object | `{"nextdoor.com/type":"memory","node.kubernetes.io/instance-type":"r6i.16xlarge"}` | (`map`) [Node selector] for Job Manager and Task Manager |
...
| tolerations | list | `[{"effect":"NoExecute","key":"node.kubernetes.io/not-ready","operator":"Exists","tolerationSeconds":300},{"effect":"NoExecute","key":"node.kubernetes.io/unreachable","operator":"Exists","tolerationSeconds":300}]` | (`map`) [Tolerations] for Job Manager and Task Manager |
