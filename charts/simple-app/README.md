...
![Version: 1.13.1](https://img.shields.io/badge/Version-1.13.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: latest](https://img.shields.io/badge/AppVersion-latest-informational?style=flat-square)
...
| istio.nativeSidecars.enabled | `bool` | `false` | Set to "true" if your app is running istio-proxy as a Kubernetes native sidecar - in which case PreStop commands should be updating initContainers of the Pod spec rather than containers. |
