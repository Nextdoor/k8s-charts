...
GET_KIND_URL   ?= https://kind.sigs.k8s.io/dl/v0.18.0/kind-$(OSNAME)-amd64
...
$(KIND):
	@echo "Downloading $(GET_KIND_URL) to $(KIND)..."
	@mkdir -p $(BIN_DIR)
...
helm_cluster: $(KIND)
	$(KIND) create cluster \
		...
		--image "kindest/node:$(KINDEST_VER)" \
		--wait 60s
